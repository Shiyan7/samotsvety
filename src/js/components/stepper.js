document.addEventListener("DOMContentLoaded", () => {
    const steppers = document.querySelectorAll('.g-stepper');

    steppers.forEach(stepper => {
        const stepperInput = stepper.querySelector('.g-stepper__input');
        const stepperBtnUp = stepper.querySelector('.g-stepper__btn--up');
        const stepperBtnDown = stepper.querySelector('.g-stepper__btn--down');
